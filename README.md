...
```bash
# 1. リポジトリをクローン
git clone https://github.com/yourusername/ursus.git
cd ursus
...
URSUS の完全なドキュメントは **[GitHub Pages](https://github.com/akinosora501/ursus-micro-edr)** で公開しています。
...
詳細は **[免責事項](https://github.com/akinosora501/ursus-micro-edr/disclaimer.html)** をご確認ください。
